...
:root {
  ...
  --shadow-md:  0 4px 20px rgba(28,74,46,.10);
  --shadow-lg:  0 8px 40px rgba(28,74,46,.12);
...
.btn-primary:hover {
  ...
  box-shadow: 0 4px 16px rgba(200,145,90,.3);
}
...
.sticky-cta {
  ...
  height: 60px;
  background: var(--green-deep);
  border-top: 2px solid rgba(200,145,90,.4);
  display: flex;
  align-items: center;
  justify-content: center;
  gap: 12px;
...
.sticky-cta-note { font-size: 11px; color: rgba(247,243,238,.55); }
...
@media (min-width: 900px) {
  .hero { grid-template-columns: 1fr 1fr; padding: 0; min-height: calc(100vh - var(--nav-h)); }
}
.hero-copy { display: flex; flex-direction: column; gap: 1.25rem; }
.hero-stars { display: flex; align-items: center; gap: 6px; }
.hero-stars .stars { color: var(--accent); font-size: 16px; letter-spacing: 1px; }
...
.trust-text-sub { font-size: 11px; color: rgba(247,243,238,.5); }
...
.service-card-link { font-size: 12px; font-weight: 600; color: var(--accent); letter-spacing: .04em; }
...
.review-text { font-size: 13px; color: rgba(247,243,238,.8); line-height: 1.7; font-style: italic; margin-bottom: .75rem; }
.review-author { font-size: 12px; font-weight: 600; color: rgba(247,243,238,.5); letter-spacing: .06em; text-transform: uppercase; }
...
.floor-callout-copy p { color: rgba(247,243,238,.75); font-size: 14px; margin-bottom: 1.25rem; line-height: 1.7; }
.floor-callout-quote {
...
.floor-callout-quote span { display: block; margin-top: .4rem; font-style: normal; font-size: 11px; font-weight: 600; letter-spacing: .08em; text-transform: uppercase; color: rgba(247,243,238,.4); }
...
.book-trust-review .review-stars { color: var(--accent); margin-bottom: .5rem; }
...
.tap-call:hover { background: #B07340; }
...
.footer-logo { font-family: var(--font-heading); font-size: 22px; font-weight: 600; color: var(--bg); line-height: 1; margin-bottom: .75rem; }
.footer-logo em { font-style: italic; color: var(--accent); }
.footer-tagline { font-size: 13px; color: rgba(247,243,238,.4); line-height: 1.6; margin-bottom: .75rem; }
.footer-stars { display: flex; align-items: center; gap: 6px; }
.footer-stars .stars { color: var(--accent); font-size: 13px; }
.footer-stars .rating { font-size: 12px; color: rgba(247,243,238,.4); }
.footer-col-title { font-size: 10px; font-weight: 600; letter-spacing: .18em; text-transform: uppercase; color: rgba(247,243,238,.35); margin-bottom: .75rem; }
.footer-col ul { display: flex; flex-direction: column; gap: .4rem; }
.footer-col a { font-size: 13px; color: rgba(247,243,238,.6); transition: color .15s; }
.footer-col a:hover { color: var(--bg); }
.footer-col p { font-size: 13px; color: rgba(247,243,238,.6); line-height: 1.6; }
...
.footer-bottom p { font-size: 11px; color: rgba(247,243,238,.25); }
